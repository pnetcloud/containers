...
Renovate tracks reviewable dependency surfaces such as GitHub Actions and npm tooling. It must not replace the CloudNativePG, TimescaleDB, Toolkit, PostgreSQL/Debian matrix, publish policy, latest policy, or Barman plugin resolver paths.
