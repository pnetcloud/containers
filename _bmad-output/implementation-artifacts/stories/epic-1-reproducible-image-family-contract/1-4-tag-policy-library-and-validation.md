...
- 2026-06-10: Addressed BMad review round 2 findings: made missing `18-trixie` latest ownership fail unconditionally, moved tag date resolution/calendar validation into shared tag policy, and proved generated tags honor `TAG_VALIDATION_DATE -> DATE -> 20260609`.
- 2026-06-10: Addressed BMad review round 3 findings within Story 1.4 scope: moved Docker tag grammar validation into shared Python tag policy and corrected stale `versions.yaml` completion notes.
