...
Current Barman plugin release, manifest, plugin image, and sidecar image values are generated in `cloudnative-pg-timescaledb/docs/generated/barman-plugin-reference.md`.
