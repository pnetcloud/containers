...
prepare_project() {
  ...
  printf 'baseline\n' >"${target}/cloudnative-pg-timescaledb/docs/generated/compatibility.md"
  printf 'baseline\n' >"${target}/cloudnative-pg-timescaledb/docs/generated/compatibility-table.md"
  ...
  printf 'baseline\n' >"${target}/cloudnative-pg-timescaledb/docs/generated/release-candidate-schema.md"
  printf 'baseline\n' >"${target}/cloudnative-pg-timescaledb/docs/generated/release-evidence-schema.md"
  printf 'baseline\n' >"${target}/cloudnative-pg-timescaledb/docs/generated/failure-reason-catalog.md"
...
compatibility_doc="${tmp_root}/compatibility-doc-change"
prepare_project "${compatibility_doc}"
printf 'changed\n' >"${compatibility_doc}/cloudnative-pg-timescaledb/docs/generated/compatibility.md"
run_stage_validate "${compatibility_doc}"
assert_staged "${compatibility_doc}" "cloudnative-pg-timescaledb/docs/generated/compatibility.md"

compatibility_table="${tmp_root}/compatibility-table-change"
prepare_project "${compatibility_table}"
printf 'changed\n' >"${compatibility_table}/cloudnative-pg-timescaledb/docs/generated/compatibility-table.md"
run_stage_validate "${compatibility_table}"
assert_staged "${compatibility_table}" "cloudnative-pg-timescaledb/docs/generated/compatibility-table.md"
...
release_candidate_schema="${tmp_root}/release-candidate-schema-change"
prepare_project "${release_candidate_schema}"
printf 'changed\n' >"${release_candidate_schema}/cloudnative-pg-timescaledb/docs/generated/release-candidate-schema.md"
run_stage_validate "${release_candidate_schema}"
assert_staged "${release_candidate_schema}" "cloudnative-pg-timescaledb/docs/generated/release-candidate-schema.md"

release_evidence_schema="${tmp_root}/release-evidence-schema-change"
prepare_project "${release_evidence_schema}"
printf 'changed\n' >"${release_evidence_schema}/cloudnative-pg-timescaledb/docs/generated/release-evidence-schema.md"
run_stage_validate "${release_evidence_schema}"
assert_staged "${release_evidence_schema}" "cloudnative-pg-timescaledb/docs/generated/release-evidence-schema.md"

failure_reason_catalog="${tmp_root}/failure-reason-catalog-change"
prepare_project "${failure_reason_catalog}"
printf 'changed\n' >"${failure_reason_catalog}/cloudnative-pg-timescaledb/docs/generated/failure-reason-catalog.md"
run_stage_validate "${failure_reason_catalog}"
assert_staged "${failure_reason_catalog}" "cloudnative-pg-timescaledb/docs/generated/failure-reason-catalog.md"
