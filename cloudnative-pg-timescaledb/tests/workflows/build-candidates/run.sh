...
manifest_line = first_line(r"imagetools create")
require(container_line and sql_line and manifest_line and container_line < manifest_line and sql_line < manifest_line, "container and SQL smoke happen before multi-platform candidate index creation", {"container": container_line, "sql": sql_line, "manifest": manifest_line}, "Do not create or hand off a multi-platform manifest before every platform smoke gate passes.")
