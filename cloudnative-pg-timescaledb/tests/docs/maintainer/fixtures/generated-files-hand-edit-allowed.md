...
`cloudnative-pg-timescaledb/versions.yaml` is the only hand-edited image source of truth. Generated outputs are committed for reviewability, but they must not be hand-edited as final fixes. Maintainers may hand-edit generated Dockerfile files as a final fix for release pressure. Generated outputs must not be hand-edited generally, but maintainers may hand-edit generated Dockerfiles as final release fixes.
...
Artifact Hub metadata is out of v1 release scope.
