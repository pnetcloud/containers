        ...
        "include": [
            {
                ...
                "debian_variant": entry["debian_variant"],
                "platforms": entry["platforms"],
                "dockerfile": dockerfile_path(entry) if entry["publish"] else "",
                "skipped_marker": "" if entry["publish"] else skipped_marker_path(entry),
                "bake_target": bake_target(entry) if entry["publish"] else "",
                "publish": entry["publish"],
                "experimental": entry["experimental"],
