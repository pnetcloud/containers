...
Default output: `cloudnative-pg-timescaledb/docs/generated/compatibility.md` plus generated companion docs in the same directory, including `compatibility-table.md`, `release-candidate-schema.md`, `release-evidence-schema.md`, `failure-reason-catalog.md`, and `release-rehearsal-report.md`.

Required JSON keys:

```json
{"docs":[{"doc_path":"cloudnative-pg-timescaledb/docs/generated/compatibility.md","companion_paths":["cloudnative-pg-timescaledb/docs/generated/compatibility-table.md"],"source":"cloudnative-pg-timescaledb/versions.yaml","sections":["compatibility"],"publishable_entries":0,"experimental_entries":2}],"generated_docs_manifest":[{"path":"cloudnative-pg-timescaledb/docs/generated/failure-reason-catalog.md","generator_input":"cloudnative-pg-timescaledb/versions.yaml","generator_command":"cloudnative-pg-timescaledb/scripts/generate-docs.sh","owner_story":"5.8","deterministic_generation_mode":"static generated failure reason catalog"},{"path":"cloudnative-pg-timescaledb/docs/generated/release-rehearsal-report.md","generator_input":"cloudnative-pg-timescaledb/versions.yaml","generator_command":"cloudnative-pg-timescaledb/scripts/release-rehearsal.sh","owner_story":"5.9","deterministic_generation_mode":"dry-run release rehearsal report"}]}
```

Consumers must require `docs[]` rows with `doc_path`, `companion_paths`, `source`, `sections`, `publishable_entries`, and `experimental_entries`. Consumers must also require `generated_docs_manifest[]` rows with `path`, `generator_input`, `generator_command`, `owner_story`, and `deterministic_generation_mode`. Public README validation consumes `compatibility-table.md` as the generated compatibility table. Release workflows must consume `release-candidate-schema.md` for Story 4.2 candidate metadata, `release-evidence-schema.md` for Story 4.4 supply-chain evidence, `failure-reason-catalog.md` for Story 5.8 troubleshooting reason IDs, and `release-rehearsal-report.md` for Story 5.9 release rehearsal evidence. Final public documentation validation is owned by Epic 5.
'''
